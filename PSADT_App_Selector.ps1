...
$adtSession = @{
    ...
    AppProcessesToClose = @('notepad','excel','winword')  # Example: @('excel', @{ Name = 'winword'; Description = 'Microsoft Word' })
    AppScriptVersion = '1.0.0'
    AppScriptDate = '2026-01-14'
    AppScriptAuthor = 'Arghya'
    RequireAdmin = $true
...
$choice = Show-ADTInstallationPrompt `
    ...
    -Message 'Which version you want to install?' `
    -ButtonRightText 'App3' `
