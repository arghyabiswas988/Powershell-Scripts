...
Register-ScheduledTask -TaskName $jobname -Description $JobDescription -Action $action -Trigger $Trigger2,$Trigger1 -RunLevel Highest -User "NT AUTHORITY\SYSTEM" -Settings $settings -Force
<#
